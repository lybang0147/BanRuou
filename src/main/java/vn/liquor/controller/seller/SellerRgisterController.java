...
public class SellerRgisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		SellerModel sell = sellerservice.checkshopname(name);
		if (sell == null) {
			...
			seller = sellerservice.getsellerbyuid(Integer.parseInt(userid));
			...
			sellerservice.registerinfo(sellerinfo);
			sellerservice.updateisseller(Integer.parseInt(userid));
